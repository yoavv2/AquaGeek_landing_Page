...
const ContactDrawer = ({ triggerText, buttonClassName }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      console.log('BASE_ID:', import.meta.env.AIRTABLE_BASE_ID);
      console.log('TABLE_NAME:', import.meta.env.AIRTABLE_TABLE_NAME);
      console.log('API_KEY:', import.meta.env.AIRTABLE_API_KEY);
